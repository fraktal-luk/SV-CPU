...
module DataL1(
    ...
    function automatic logic isUncachedRange(input Mword adr);
        return //adr[31];
               adr >= UNCACHED_BASE && adr < UNCACHED_BASE + $size(uncachedArea);
    endfunction
